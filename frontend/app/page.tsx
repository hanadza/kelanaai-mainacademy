      ...
      <header className="intro mb-3 border-b-2 border-slate-900 pb-2.5 shrink-0">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-1.5 border-2 border-slate-900 bg-white text-slate-900 px-3 py-1 text-xs font-bold uppercase tracking-wider shadow-[3px_3px_0_#18221f] hover:bg-slate-100 hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[5px_5px_0_#18221f] cursor-pointer active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0_#18221f] transition-all duration-150 no-underline"
            >
              <span>ABOUT</span>
